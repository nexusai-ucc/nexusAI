...
confiabilidad, privacidad, testing automatizado y el deploy propio.
...
```
nexusAI/                         # Raíz del repo
├── README.md, CHANGELOG.md      # Estos archivos (nivel raíz)
├── NexusAI/                     # Todo el proyecto vive acá adentro
...
│   │       ├── app/
│   │       │   ├── chat/, documents/, search/, quiz/, forums/,
│   │       │   │   gaps/, analytics/, admin/, calendar/,
│   │       │   │   courses/, auth/, providers/, prompts/, db/, shared/
│   │       ├── migrations/       # Alembic
│   │       ├── tests/
│   │       └── Dockerfile
│   ├── docs/                     # Documentación técnica (ADRs, diagramas, fases)
...
Guía completa (con troubleshooting) en [`docs/CORRER_PROYECTO.md`](NexusAI/docs/CORRER_PROYECTO.md).
...
automatizado, publicación oficial del plugin y deploy propio.
