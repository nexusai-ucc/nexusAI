...
$plugin->version   = 2026081002;        // ASIST-06 (colapsar texto largo en el chat).
$plugin->release   = '0.10.10';          // ASIST-06: pegado colapsable + respuestas largas con "Mostrar más" (issue #384).
