...
$plugin->version   = 2026070901;        // YYYYMMDDXX — SP-10: sugerencias de repaso basadas en errores (persistidas en backend).
$plugin->release   = '0.9.6';            // Quiz multi-tipo + evaluación IA + repaso de errores + sugerencias de repaso.
