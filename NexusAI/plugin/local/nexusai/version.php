...
$plugin->version   = 2026071501;        // YYYYMMDDXX — SP-04 (fill_blank) + SP-09 (historial de quizzes por alumno).
$plugin->release   = '0.9.7';            // Quiz multi-tipo + fill-in-the-blank + historial de quizzes + repaso de errores + foros IA.
